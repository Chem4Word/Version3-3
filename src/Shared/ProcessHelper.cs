...
namespace Chem4Word.Shared
{
    ...
    {
        // Current: Chem4Word-Setup.3.3.{build}.Release.{n}.msi
        // New: msiexec /i Chem4Word-Setup.3.3.{build}.Release.{n}.msi /l*v Chem4Word-Setup.3.3.{build}.Release.{n}-{yyyy-MM-dd.HH-mm-ss.fff}.log
